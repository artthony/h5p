H5P.ColumnCustom = (function (EventDispatcher) {
  ...
  function Column(params, id, data) {
    ...
    var addRunnable = function (content, contentData) {
      ...
      if (library === 'H5P.Image' || library === 'H5P.TwitterUserFeed' || library === 'H5P.Multicard' || library === 'H5P.TextNImage') {
